package com.catacore.richtexteditor.keyboard;
...
//            setBackgroundDrawable(new ColorDrawable(0xFFFF6666));
...
//            this.keyboardPortraitHeight = 0;
     ...
     *
     */
    private void notifyKeyboardHeightChanged(int height, int orientation, boolean isVisible) {
        if (observer != null) {
            observer.onKeyboardHeightChanged(height, orientation,isVisible);
        }
    }
}
